...
public class XMLLexiconTest {
    ...
    public void setUp() {
        ...
        // lexicon instead
        this.lexicon = new simplenlg.lexicon.spanish.XMLLexicon();
    ...
    public void xmlLexiconImmutabilityTest() {
        ...
        // "wall" is singular.
        NPPhraseSpec pared = factory.createNounPhrase("la", "pared");
        ...
        SPhraseSpec sentence = factory.createClause("movimiento", "observar");
        sentence.setFeature(Feature.TENSE, Tense.PAST);
        PPPhraseSpec pp = factory.createPrepositionPhrase("en", pared);
        ...
        pared = factory.createNounPhrase("la", "pared");
        Assert.assertEquals(NumberAgreement.SINGULAR, pared.getFeature(Feature.NUMBER));
    }

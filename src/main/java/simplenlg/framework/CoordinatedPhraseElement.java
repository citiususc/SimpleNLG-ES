...
public class CoordinatedPhraseElement extends NLGElement {
     ...
     * @param factory     the factory for this phrase
     */
    public CoordinatedPhraseElement(Object coordinate1, Object coordinate2, NLGFactory factory) {

        setFactory(factory);
        this.addCoordinate(coordinate1);
        this.addCoordinate(coordinate2);
        for (NLGElement coordinate : this.getChildren()) {
    ...
    public boolean checkIfPlural() {
        ...
        if (size == 1)
            ...
            return getFactory().getLexicon().PLURAL_COORDINATORS.contains(getConjunction());
    }
}

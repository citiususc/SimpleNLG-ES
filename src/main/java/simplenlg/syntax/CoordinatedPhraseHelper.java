...
public abstract class CoordinatedPhraseHelper {
    ...
    public CoordinatedPhraseHelper(PhraseHelper phraseHelper) {
     ...
     */
    public NLGElement realise(SyntaxProcessor parent,
     ...
     *               coordination.
     */
    private void setChildFeatures(CoordinatedPhraseElement phrase,
                                  NLGElement child) {
     ...
     */
    private void raiseSpecifier(List<NLGElement> children) {

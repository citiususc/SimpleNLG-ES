...
public abstract class PhraseHelper {
    ...
    public NLGElement realise(SyntaxProcessor parent, PhraseElement phrase) {
        ...
        if (phrase != null) {
            ...
            this.realiseList(parent, realisedElement, phrase
     ...
     */
    private void realiseComplements(SyntaxProcessor parent, PhraseElement phrase, ListElement realisedElement) {
            ...
            if (currentElement != null) {
                ...
                if (firstProcessed) {
                    realisedElement.addComponent(new InflectedWordElement(
                            parent.getLexicon().getAdditionCoordConjunction().getBaseForm(), LexicalCategory.CONJUNCTION)); //$NON-NLS-1$
                } else {
                    firstProcessed = true;
                }
     ...
     * @param realisedElement the current realisation of the noun phrase.
     */
    private void realiseHead(SyntaxProcessor parent, PhraseElement phrase, ListElement realisedElement) {
     ...
     */
    public void realiseList(SyntaxProcessor parent,
